...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://D:/web/portfolio-web/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/web/portfolio-web/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/web/portfolio-web/node_modules/devalue/index.js';
import destr from 'file://D:/web/portfolio-web/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://D:/web/portfolio-web/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/web/portfolio-web/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://D:/web/portfolio-web/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file://D:/web/portfolio-web/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/web/portfolio-web/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/web/portfolio-web/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/web/portfolio-web/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://D:/web/portfolio-web/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://D:/web/portfolio-web/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://D:/web/portfolio-web/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://D:/web/portfolio-web/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/web/portfolio-web/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/web/portfolio-web/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/web/portfolio-web/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://D:/web/portfolio-web/node_modules/unctx/dist/index.mjs';
import { isVNode, version, unref } from 'file://D:/web/portfolio-web/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://D:/web/portfolio-web/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/web/portfolio-web/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"D:/web/portfolio-web/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\web\\portfolio-web","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\web\\portfolio-web\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\web\\portfolio-web\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\web\\portfolio-web\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\web\\portfolio-web\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _a9vdpSBWc5 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/web/portfolio-web";
...
const _lazy_dMrbn3 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_dMrbn3, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_dMrbn3, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/web/portfolio-web/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/web/portfolio-web/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
